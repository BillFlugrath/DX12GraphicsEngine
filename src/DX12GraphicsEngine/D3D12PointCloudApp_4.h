...
class D3D12PointCloudApp_4 : public DXSample
{
public:
	D3D12PointCloudApp_4(UINT width, UINT height, std::wstring name);
	~D3D12PointCloudApp_4();

	static D3D12PointCloudApp_4* Get() { return s_app; }
...
private:
  ...
  // the mhIntermediateRttCpuSrv and mhIntermediateRttGpuSrv are used for creating and setting the 
	...
	static D3D12PointCloudApp_4* s_app;
