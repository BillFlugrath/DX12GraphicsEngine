...
class DX12Raytracing_Inline_1 : public DXSample
{
public:
	DX12Raytracing_Inline_1(UINT width, UINT height, std::wstring name);
	~DX12Raytracing_Inline_1();

	static DX12Raytracing_Inline_1* Get() { return s_app; }
...
private:
  ...
  // the mhIntermediateRttCpuSrv and mhIntermediateRttGpuSrv are used for creating and setting the 
	...
	static DX12Raytracing_Inline_1* s_app;
