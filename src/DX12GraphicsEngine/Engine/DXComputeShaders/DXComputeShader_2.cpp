...
DXComputeShader_2::DXComputeShader_2()
{
}
...
bool DXComputeShader_2::Initialize(ComPtr<ID3D12Device>& device, std::shared_ptr<DXDescriptorHeap> descriptor_heap_srv, const std::wstring& filename)
{
...
void  DXComputeShader_2::BuildRootSignature()
{
...
void  DXComputeShader_2::BuildPSOs()
{
	DXComputeShader::BuildPSOs();
}


void DXComputeShader_2::DoComputeWork()
{
...
//	mCommandList->ResourceBarrier(1, &CD3DX12_RESOURCE_BARRIER::Transition(mBuffMap0.Get(),
	...
	if (bDebugWriteDataToDisk)
	{
		...
		D3D12_RANGE readbackBufferRange{ 0, sizeof(TestData) };
...
void DXComputeShader_2::BuildResources()
{
...
void DXComputeShader_2::BuildDescriptors()
{
