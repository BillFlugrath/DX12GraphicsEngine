...
/* 
GPU Gems Chapter 5 https://github.com/Apress/Ray-Tracing-Gems-II/
Except for DepthGradient, all functions are FROM THE ERRATA file!!  Thus that is the HLSL code that is used below.
*/
