...
It contains a few demo applications that show how to setup DX12 for rendering.  These applications include standard rendering as well as ray tracing with DXR.  An example of inline ray tracing from within a pixel shader is also included.  There is also a working example of a mesh shader that renders along with other renderers in the scene.
